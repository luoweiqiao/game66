...
static void MD4Transform(uint32_t a[4], uint8_t b[64]);
static void Encode(uint8_t*, uint32_t*, size_t);
static void Decode(uint32_t*, uint8_t*, size_t);
static void MD4_memcpy(uint8_t*, uint8_t*, size_t);
static void MD4_memset(uint8_t*, int, size_t);
...
)
{
   ...
   */
  MD4_memset ((uint8_t *)context, 0, sizeof (*context));
...
static void MD4Transform (uint32_t state[4], uint8_t block[64])
{
  ...
  /* Zeroize sensitive information.
   */
  MD4_memset ((uint8_t *)x, 0, sizeof (x));
}
 ...
 */
static void MD4_memcpy (uint8_t * output, uint8_t * input, size_t len)
{
  size_t i;
 ...
 */
static void MD4_memset (uint8_t* output, int value, size_t len)
{
  size_t i;
