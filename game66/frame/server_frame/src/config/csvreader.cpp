...
std::string CCsvConfigReader::GetFieldValueToString()
{
	return ReadFieldValue();
}
short CCsvConfigReader::GetFieldValueToShort()
{
	std::string e = ReadFieldValue();
	return (static_cast<short>(atoi(e.c_str())));
}
int CCsvConfigReader::GetFieldValueToInt()
{
	std::string e = ReadFieldValue();
	return (static_cast<int>(atoi(e.c_str())));
}
double CCsvConfigReader::GetFieldValueToDouble()
{
	std::string e = ReadFieldValue();
	return atof(e.c_str());
}
bool CCsvConfigReader::GetFieldValueToBool()
{
	std::string e = ReadFieldValue();
	int temp = static_cast<int>(atoi(e.c_str()));
	if (temp > 0) {
		return true;
	}
	else {
...
std::string CCsvConfigReader::GetFieldValueToString(int rownum, std::string strcol)
{
	return GetFieldValue(rownum, strcol);
}
short CCsvConfigReader::GetFieldValueToShort(int rownum, std::string strcol)
{
	std::string e = GetFieldValue(rownum, strcol);
	return (static_cast<short>(atoi(e.c_str())));
}
int CCsvConfigReader::GetFieldValueToInt(int rownum, std::string strcol)
{
	std::string e = GetFieldValue(rownum, strcol);
	return (static_cast<int>(atoi(e.c_str())));
}
double CCsvConfigReader::GetFieldValueToDouble(int rownum, std::string strcol)
{
	std::string e = GetFieldValue(rownum, strcol);
	return atof(e.c_str());
}
bool CCsvConfigReader::GetFieldValueToBool(int rownum, std::string strcol)
{
	std::string e = GetFieldValue(rownum, strcol);
	int temp = static_cast<int>(atoi(e.c_str()));
	if (temp > 0) {
