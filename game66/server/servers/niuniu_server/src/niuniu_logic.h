...
//static const int NIU_MULTIPLE_COUNT = 5; // 抢庄倍数选择数量 0 1 2 3 4 一共五个选择
#define NIU_MULTIPLE_COUNT 5
...
public:
	...
	CGameNiuniuTable*  m_pHostTable;
	void SetTable(CGameNiuniuTable* pTable);
	//函数定义
public:
	//构造函数
	CNiuNiuLogic();
...
public:
	...
	//获取牌型扑克
	bool GetCardTypeData(int iArProCardType[], BYTE cbArCardData[][NIUNIU_CARD_NUM]);
	//获取点数类型
