...
{
//扑克数据
BYTE CWarLogic::m_cbCardListData[52]=
{
...
BYTE CWarLogic::m_cbArCardColor[4]  = { 0x00,0x10,0x20,0x30 };
BYTE CWarLogic::m_cbArCardValue[13] = { 0x01,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x09,0x0A,0x0B,0x0C,0x0D };
...
//获取对子数值
BYTE CWarLogic::GetDoubleValue(BYTE cbCardData[], BYTE cbCardCount)
{
...
//获取类型
BYTE CWarLogic::GetCardType(BYTE cbCardData[], BYTE cbCardCount)
{
...
//获得散牌最大值
BYTE CWarLogic::GetSingCardValue(BYTE cbCardData[], BYTE cbCardCount)
{
	//设置变量
...
//排列扑克
void CWarLogic::SortCardList(BYTE cbCardData[], BYTE cbCardCount,bool bAsc)
{
	//转换数值
...
//混乱扑克
void CWarLogic::RandCardList(BYTE cbCardBuffer[], BYTE cbBufferCount)
{
	//混乱准备
...
//逻辑数值
BYTE CWarLogic::GetCardLogicValue(BYTE cbCardData)
{
	//扑克属性
...
bool CWarLogic::IsSameCard(BYTE cbFirstData[], BYTE cbNextData[], BYTE cbCardCount)
{
...
//对比扑克
BYTE CWarLogic::CompareCard(BYTE cbFirstData[], BYTE cbNextData[], BYTE cbCardCount)
{
	//设置变量
...
bool CWarLogic::GetCardTypeData(int iArProCardType[], BYTE cbArCardData[][MAX_COUNT])
{
	...
	for (int i = 0; i < SHOW_CARD_COUNT; i++)
	{
		...
		{
			for (int iLoopIndex = 0; iLoopIndex < 1024; iLoopIndex++)
			{
...
bool CWarLogic::IsValidCard(BYTE cbCardData)
{
...
//获取颜色
BYTE CWarLogic::GetRandCardColor()
{
...
//获取数值
BYTE CWarLogic::GetRandCardValue()
{
...
//获取豹子
bool CWarLogic::GetTypeBaoZi(BYTE cbCardListData[], BYTE cbListCount, BYTE cbCardData[], BYTE cbCardCount)
{
	// 统计数值数目
...
//获取顺金（同花顺）
bool CWarLogic::GetTypeShunJin(BYTE cbCardListData[], BYTE cbListCount, BYTE cbCardData[], BYTE cbCardCount)
{
...
//获取金花（同花）
bool CWarLogic::GetTypeJinHua(BYTE cbCardListData[], BYTE cbListCount, BYTE cbCardData[], BYTE cbCardCount)
{
	// 统计颜色数目
...
//获取顺子
bool CWarLogic::GetTypeShunZi(BYTE cbCardListData[], BYTE cbListCount, BYTE cbCardData[], BYTE cbCardCount)
{
	// 统计数值数目
	BYTE cbArCardValueCount[MAX_CARD_VALUE] = { 0 };
	for (BYTE i = 0; i < cbListCount; i++)
...
//获取对子
bool CWarLogic::GetTypeDouble(BYTE cbCardListData[], BYTE cbListCount, BYTE cbCardData[], BYTE cbCardCount)
{
	// 统计数值数目
	BYTE cbArCardValueCount[MAX_CARD_VALUE] = { 0 };
	for (BYTE i = 0; i < cbListCount; i++)
...
//获取散牌
bool CWarLogic::GetTypeSingle(BYTE cbCardListData[], BYTE cbListCount, BYTE cbCardData[], BYTE cbCardCount)
{
	BYTE cbTempListCount = 0;
